...
public class Customer {
	...
	public Customer(String first_name, String last_name, String date_of_birth, String telephone_no, String email, String company_name, String legal_form, String tax_id, String street, String house_no, String postal_code, String city) {
		if(first_name.equals("None")) {
			isPrivatePerson = false;
		}
		else {
			isPrivatePerson = true;
			date_of_birth = DateConverter.convertFromSQLToNormal(date_of_birth);
		}
		
//		DateFormat originalFormat = new SimpleDateFormat("yyyy-mm-dd");
//		DateFormat targetFormat = new SimpleDateFormat("dd.mm.yyy");
//		try {
//			Date date = (Date) originalFormat.parse(date_of_birth);
//			date_of_birth = targetFormat.format(date);
	...
	public String toString() {
		...
		if(isPrivatePerson) {
			customerAsString = "Es handelt sich um einen Privatkunden. Die Kundendaten lauten: \n\n" + "Name: " + this.last_name + ", " + this.first_name +"\n" + 
								"Geboren am: " + this.date_of_birth + "\n" + "Wohnhaft in: " + this.street + " " + this.house_no + ", " + this.postal_code + " " + 
