...
public class Offer {
	...
	public Offer(String id, String date_of_creation, String gross_price, String real_estate_street, String real_estate_house_no, String real_estate_postal_code, String real_estate_city) {
		this.id = id;
	...
	public String toString() {
		String offerAsString = "Angebots-ID: " + this.id + "\n" + "Angelegt am: " + this.date_of_creation + "\n" + "Geschätzter Preis: " + this.gross_price + "€\n" +
								"Ausführungsadresse: " + this.real_estate_street + " " + this.real_estate_house_no + ", " + this.real_estate_postal_code + " " + 
								this.real_estate_city + "\n";
