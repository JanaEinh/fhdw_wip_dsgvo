...
//			emailContent = emailContent.replaceAll("Ae", "�");
//			emailContent = emailContent.replaceAll("ae", "�");
//			emailContent = emailContent.replaceAll("Oe", "�");
//			emailContent = emailContent.replaceAll("oe", "�");
//			emailContent = emailContent.replaceAll("Ue", "�");
//			emailContent = emailContent.replaceAll("ue", "�");
